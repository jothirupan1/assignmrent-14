...
function Products() {
  ...
  return (
    <div>
          ...
          {change.map((item,index) =>(
            <div className="col-sm-12 col-md-4 col-lg-3 text-center" key={index}>
              <div className="card shadow-sm">
                <img src={item.image} alt="" className='card-img-top p-3 ' style={{ height :"250px",  objectFit:"contain"}}/>
       ...
       <Link to="/New" className="btn btn-outline-primary text-uppercase"> See more </Link>
        </div>
